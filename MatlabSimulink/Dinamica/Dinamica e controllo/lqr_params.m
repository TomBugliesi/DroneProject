function [reg_dir_lqr_z, reg_fb_lqr_z, G0_fb_lqr_z, reg_dir_lqr_R, reg_fb_lqr_R, G0_fb_lqr_R, reg_dir_lqr_Y, reg_fb_lqr_Y, G0_fb_lqr_Y] = lqr_params(k_Q_z,k_R_z,k_Q_R,k_R_R,k_Q_Y,k_R_Y)
run('controllo.m');
