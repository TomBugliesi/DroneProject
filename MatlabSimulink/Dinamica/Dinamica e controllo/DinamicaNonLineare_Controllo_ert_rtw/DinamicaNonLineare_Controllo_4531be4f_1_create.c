...
int32_T sm_ssci_logFcn_codeGen(const NeDae *dae,
  ...
  PmRealVector *output);
extern const NeAssertData DinamicaNonLineare_Controllo_4531be4f_1_assertData[];
extern const NeZCData DinamicaNonLineare_Controllo_4531be4f_1_ZCData[];
void DinamicaNonLineare_Controllo_4531be4f_1_computeRuntimeParameters(
  const double *runtimeRootVariables,
  double *runtimeParameters);
void DinamicaNonLineare_Controllo_4531be4f_1_validateRuntimeParameters(
...
void DinamicaNonLineare_Controllo_4531be4f_1_computeSimRuntimeDerivedValues(
  const double *runtimeParameters,
  RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle);
PmfMessageId DinamicaNonLineare_Controllo_4531be4f_1_compDerivs(
...
PmfMessageId DinamicaNonLineare_Controllo_4531be4f_1_numJacPerturbLoBounds(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId DinamicaNonLineare_Controllo_4531be4f_1_numJacPerturbHiBounds(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId DinamicaNonLineare_Controllo_4531be4f_1_checkDynamics(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const double *, const double *, const double *,
  const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId DinamicaNonLineare_Controllo_4531be4f_1_compOutputsDyn(
  const RuntimeDerivedValuesBundle *,
  const int *,
  const double *,
  const int *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId DinamicaNonLineare_Controllo_4531be4f_1_compOutputsKin(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const int *,
  const double *, const double *, const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId DinamicaNonLineare_Controllo_4531be4f_1_compOutputs (
  const RuntimeDerivedValuesBundle *,
  const double *,
  const int *,
  const double *, const double *, const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId DinamicaNonLineare_Controllo_4531be4f_1_computeAsmModeVector(
  const double *, const double *, const double *,
  int *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId DinamicaNonLineare_Controllo_4531be4f_1_computeSimModeVector(
  const double *, const double *, const double *,
  int *,
  double *,
  NeuDiagnosticManager *neDiagMgr);
PmfMessageId DinamicaNonLineare_Controllo_4531be4f_1_computeZeroCrossings(
  const RuntimeDerivedValuesBundle *,
  const double *,
  const double *, const double *, const double *,
  const double *,
  ...
  double *,
  NeuDiagnosticManager *neDiagMgr);
void DinamicaNonLineare_Controllo_4531be4f_1_setTargets(
...
void DinamicaNonLineare_Controllo_4531be4f_1_resetSimStateVector(const void
  *mech, double *stateVector);
void DinamicaNonLineare_Controllo_4531be4f_1_initializeTrackedAngleState(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *modeVector,
  const double *motionData,
  double *stateVector);
void DinamicaNonLineare_Controllo_4531be4f_1_computeDiscreteState(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  double *stateVector);
void DinamicaNonLineare_Controllo_4531be4f_1_adjustPosition(
  const void *mech,
  const double *dofDeltas,
  double *stateVector);
void DinamicaNonLineare_Controllo_4531be4f_1_perturbAsmJointPrimitiveState(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  double magnitude,
  ...
  double *stateVector);
void DinamicaNonLineare_Controllo_4531be4f_1_perturbSimJointPrimitiveState(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  double magnitude,
  boolean_T doPerturbVelocity,
  double *stateVector);
void DinamicaNonLineare_Controllo_4531be4f_1_perturbFlexibleBodyState(
  const void *mech,
  size_t stageIdx,
  double magnitude,
  boolean_T doPerturbVelocity,
  double *stateVector);
void DinamicaNonLineare_Controllo_4531be4f_1_computePosDofBlendMatrix(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  ...
  int partialType,
  double *matrix);
void DinamicaNonLineare_Controllo_4531be4f_1_computeVelDofBlendMatrix(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  const double *stateVector,
  int partialType,
  double *matrix);
void DinamicaNonLineare_Controllo_4531be4f_1_projectPartiallyTargetedPos(
  const void *mech,
  size_t stageIdx,
  size_t primitiveIdx,
  ...
  int partialType,
  double *stateVector);
void DinamicaNonLineare_Controllo_4531be4f_1_propagateMotion(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  double *motionData);
size_t DinamicaNonLineare_Controllo_4531be4f_1_computeAssemblyError(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  ...
  const double *motionData,
  double *error);
size_t DinamicaNonLineare_Controllo_4531be4f_1_computeAssemblyJacobian(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  size_t constraintIdx,
  ...
  const double *motionData,
  double *J);
size_t DinamicaNonLineare_Controllo_4531be4f_1_computeFullAssemblyJacobian(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  const int *modeVector,
  const double *motionData,
  double *J);
int DinamicaNonLineare_Controllo_4531be4f_1_isInKinematicSingularity(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  size_t constraintIdx,
  const int *modeVector,
  const double *motionData);
void DinamicaNonLineare_Controllo_4531be4f_1_convertStateVector(
  const void *asmMech,
...
void DinamicaNonLineare_Controllo_4531be4f_1_constructStateVector(
  const void *mech,
...
void DinamicaNonLineare_Controllo_4531be4f_1_extractSolverStateVector(
  const void *mech,
  const double *fullStateVector,
  double *solverStateVector);
boolean_T DinamicaNonLineare_Controllo_4531be4f_1_isPositionViolation(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const double *stateVector,
  const int *modeVector);
boolean_T DinamicaNonLineare_Controllo_4531be4f_1_isVelocityViolation(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const double *stateVector,
  const int *modeVector);
PmfMessageId DinamicaNonLineare_Controllo_4531be4f_1_projectStateSim(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const int *modeVector,
  double *stateVector,
  void *neDiagMgr);
void DinamicaNonLineare_Controllo_4531be4f_1_computeConstraintError(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const double *stateVector,
  const int *modeVector,
  double *error);
void DinamicaNonLineare_Controllo_4531be4f_1_resetModeVector(const void *mech,
  int *modeVector);
boolean_T DinamicaNonLineare_Controllo_4531be4f_1_hasJointDisToNormModeChange(
  const void *mech,
  const int *prevModeVector,
  const int *modeVector);
PmfMessageId
  DinamicaNonLineare_Controllo_4531be4f_1_performJointDisToNormModeChange(
  const void *mech,
  const RuntimeDerivedValuesBundle *runtimeDerivedValuesBundle,
  const int *constraintEqnEnableFlags,
  const int *prevModeVector,
  ...
  double *stateVector,
  void *neDiagMgr);
void DinamicaNonLineare_Controllo_4531be4f_1_onModeChangedCutJoints(
  const void *mech,
  const int *prevModeVector,
  const int *modeVector,
  double *stateVector);
PmfMessageId DinamicaNonLineare_Controllo_4531be4f_1_assemble(const double *u,
  ...
  const NeParameterBundle *paramBundle)
{
  ...
  if (smData->mRuntimeParameterScalars.mN == 0)
    return;
  DinamicaNonLineare_Controllo_4531be4f_1_computeRuntimeParameters(
    runtimeRootVariables,
    smData->mRuntimeParameterScalars.mX);
  DinamicaNonLineare_Controllo_4531be4f_1_computeAsmRuntimeDerivedValues(
    smData->mRuntimeParameterScalars.mX,
    &dae->mPrivateData->mAsmRuntimeDerivedValuesBundle);
  DinamicaNonLineare_Controllo_4531be4f_1_computeSimRuntimeDerivedValues(
    smData->mRuntimeParameterScalars.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  (void) systemInput;
  (void) neDiagMgr;
  DinamicaNonLineare_Controllo_4531be4f_1_validateRuntimeParameters(
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (smData->mCachedDerivativesAvailable)
    ...
    errorId = DinamicaNonLineare_Controllo_4531be4f_1_compDerivs(
      &smData->mSimRuntimeDerivedValuesBundle,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = DinamicaNonLineare_Controllo_4531be4f_1_numJacPerturbLoBounds(
    &smData->mSimRuntimeDerivedValuesBundle,
    smData->mSimulationDelegate
    .mRunTimeEnabledEquations.mValues,
    systemInput->mX.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = DinamicaNonLineare_Controllo_4531be4f_1_numJacPerturbHiBounds(
    &smData->mSimRuntimeDerivedValuesBundle,
    smData->mSimulationDelegate
    .mRunTimeEnabledEquations.mValues,
    systemInput->mX.mX,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  PmfMessageId errorId = NULL;
  double errorResult = 0.0;
  errorId = DinamicaNonLineare_Controllo_4531be4f_1_computeSimModeVector(
    systemInput->mU.mX,
    systemInput->mU.mX + 3,
    systemInput->mV.mX + 3,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  double errorResult = 0.0;
  return
    DinamicaNonLineare_Controllo_4531be4f_1_computeZeroCrossings(
    &smData->mSimRuntimeDerivedValuesBundle,
    systemInput->mX.mX,
    systemInput->mU.mX,
    systemInput->mU.mX + 3,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (errorId == NULL) {
    double result = 0.0;
    errorId = DinamicaNonLineare_Controllo_4531be4f_1_checkDynamics(
      &smData->mSimRuntimeDerivedValuesBundle,
      systemInput->mX.mX,
      systemInput->mU.mX,
      systemInput->mU.mX + 3,
  ...
  NeuDiagnosticManager *neDiagMgr)
{
  ...
  if (smData->mAssemblyModeVector.mN > 0) {
    errorId = DinamicaNonLineare_Controllo_4531be4f_1_computeAsmModeVector(
      systemInput->mU.mX,
      systemInput->mU.mX + 3,
      systemInput->mV.mX + 3,
  ...
  DinamicaNonLineare_Controllo_4531be4f_1_checkTargets(
    &smData->mSimRuntimeDerivedValuesBundle,
  ...
  void initStateVector(NeDaePrivateData *smData)
{
  ...
  const CTarget targets[12] = {
    { 0, 5, 0, false, 0, 0, "1", false, true, +1.000000000000000000e+00, true, 1,
      { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 5, 0, false, 0, 0, "1", true, true, +1.000000000000000000e+00, true, 1,
      { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 5, 1, false, 0, 0, "1", false, true, +1.000000000000000000e+00, true, 1,
      { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 5, 1, false, 0, 0, "1", true, true, +1.000000000000000000e+00, true, 1,
      { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 5, 2, false, 0, 0, "1", false, true, +1.000000000000000000e+00, true, 1,
      { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 5, 2, false, 0, 0, "1", true, true, +1.000000000000000000e+00, true, 1,
      { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 5, 0, false, 0, 3, "", false, false, +1.000000000000000000e+00, true, 1,
      { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 5, 0, false, 0, 3, "", true, false, +1.000000000000000000e+00, true, 1,
      { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 5, 1, false, 0, 3, "", false, false, +1.000000000000000000e+00, true, 1,
      { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 5, 1, false, 0, 3, "", true, false, +1.000000000000000000e+00, true, 1,
      { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 5, 2, false, 0, 3, "", false, false, +1.000000000000000000e+00, true, 1,
      { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } },

    { 0, 5, 2, false, 0, 3, "", true, false, +1.000000000000000000e+00, true, 1,
      { +0.000000000000000000e+00, +0.000000000000000000e+00,
        +0.000000000000000000e+00, +0.000000000000000000e+00 }, { +
        0.000000000000000000e+00 } }
  };
  ...
  status = pm_create_real_vector_fields(
    &smData->mAssemblyFullStateVector, 6, alloc);
  checkMemAllocStatus(status);
  status = pm_create_real_vector_fields(
    &smData->mSimulationFullStateVector, 6, alloc);
  checkMemAllocStatus(status);
...
static void initAsserts(NeDaePrivateData *smData)
{
  ...
  if (smData->mNumParamAsserts > 0) {
    const NeAssertData *ad = DinamicaNonLineare_Controllo_4531be4f_1_assertData;
    size_t i;
...
static void initZeroCrossings(NeDaePrivateData *smData)
{
  ...
  if (smData->mNumZeroCrossings > 0) {
    const NeZCData *zcd = DinamicaNonLineare_Controllo_4531be4f_1_ZCData;
    size_t i;
  ...
  void initIoInfo(NeDaePrivateData *smData)
{
  const char *inputPortPaths[3] = {
    "simscape.Gimbal_Joint.qxi",
    "simscape.Gimbal_Joint.qyi",
    "simscape.Gimbal_Joint.qzi"
  };
  ...
  void initAssemblyDelegate(SmMechanismDelegate *delegate)
{
  ...
  const SmSizePair stateOffsets[3] = {
    { 0, 3 }, { 1, 4 }, { 2, 5 }
  };

  const SmSizePair dofOffsets[3] = {
    { 0, 1 }, { 1, 2 }, { 2, 3 }
  };

  const size_t *flexibleStages = NULL;
  const size_t remodIndices[3] = {
    0, 1, 2
  };

  const size_t *equationsPerConstraint = NULL;
  const size_t dofToVelSlot[3] = {
    3, 4, 5
  };
  ...
  delegate->mTreeJointDof = 3;
  delegate->mDof = 3;
  delegate->mStateSize = 6;
  delegate->mContinuousStateSize = 6;
  ...
  sm_core_SmBoundedSet_create(&scratchpad->mPosRequired, 3);
  sm_core_SmBoundedSet_create(&scratchpad->mPosDesired, 3);
  sm_core_SmBoundedSet_create(&scratchpad->mPosSuggested, 3);
  sm_core_SmBoundedSet_create(&scratchpad->mPosFree, 3);
  sm_core_SmBoundedSet_create(&scratchpad->mPosNonRequired, 3);
  ...
  sm_core_SmSizePairVector_create(
    &scratchpad->mPartiallyPosTargetedPrims, 3, &zeroSizePair);
  sm_core_SmSizePairVector_create(
    &scratchpad->mPartiallyVelTargetedPrims, 3, &zeroSizePair);
  sm_core_SmSizeTVector_create(&scratchpad->mPosPartialTypes, 3, 0);
  sm_core_SmSizeTVector_create(&scratchpad->mVelPartialTypes, 3, 0);
  sm_core_SmSizeTVector_create(&scratchpad->mPartiallyActivePrims, 3, 0);
  sm_core_SmSizePairVector_create(
    &scratchpad->mBaseFrameVelOffsets, 0, &zeroSizePair);
  sm_core_SmSizePairVector_create(
    &scratchpad->mCvVelOffsets, 3, &zeroSizePair);
  sm_core_SmRealVector_create(
    &scratchpad->mCvAzimuthValues, 3, 0.0);
  sm_core_SmRealVector_create(&scratchpad->mInitialState, 6, 0.0);
  sm_core_SmRealVector_create(&scratchpad->mStartState, 6, 0.0);
  sm_core_SmRealVector_create(&scratchpad->mTestState, 6, 0.0);
  sm_core_SmRealVector_create(&scratchpad->mFullStateVector, 6, 0.0);
  ...
  sm_core_SmRealVector_create(&scratchpad->mDeltas,
    Jn * (Jm <= Jn ? Jm : Jn), 0.0);
  sm_core_SmRealVector_create(&scratchpad->mSvdWork, 16, 0.0);
  sm_core_SmRealVector_create(
    &scratchpad->mLineSearchScaledDeltaVect, 3, 0.0);
  sm_core_SmRealVector_create(
    &scratchpad->mLineSearchTestStateVect, 6, 0.0);
  sm_core_SmRealVector_create(&scratchpad->mLineSearchErrorVect, Jm, 0.0);
  sm_core_SmRealVector_create(&scratchpad->mActiveDofVelsVect, 3, 0.0);
  sm_core_SmRealVector_create(&scratchpad->mVelSystemRhs, Jm, 0.0);
  sm_core_SmRealVector_create(&scratchpad->mMotionData, 13, 0.0);
  delegate->mSetTargets = DinamicaNonLineare_Controllo_4531be4f_1_setTargets;
  delegate->mResetStateVector =
    DinamicaNonLineare_Controllo_4531be4f_1_resetAsmStateVector;
  delegate->mInitializeTrackedAngleState =
    DinamicaNonLineare_Controllo_4531be4f_1_initializeTrackedAngleState;
  delegate->mComputeDiscreteState =
    DinamicaNonLineare_Controllo_4531be4f_1_computeDiscreteState;
  delegate->mAdjustPosition =
    DinamicaNonLineare_Controllo_4531be4f_1_adjustPosition;
  delegate->mPerturbJointPrimitiveState =
    DinamicaNonLineare_Controllo_4531be4f_1_perturbAsmJointPrimitiveState;
  delegate->mPerturbFlexibleBodyState = NULL;
  delegate->mComputePosDofBlendMatrix =
    DinamicaNonLineare_Controllo_4531be4f_1_computePosDofBlendMatrix;
  delegate->mComputeVelDofBlendMatrix =
    DinamicaNonLineare_Controllo_4531be4f_1_computeVelDofBlendMatrix;
  delegate->mProjectPartiallyTargetedPos =
    DinamicaNonLineare_Controllo_4531be4f_1_projectPartiallyTargetedPos;
  delegate->mPropagateMotion =
    DinamicaNonLineare_Controllo_4531be4f_1_propagateMotion;
  delegate->mComputeAssemblyError =
    DinamicaNonLineare_Controllo_4531be4f_1_computeAssemblyError;
  delegate->mComputeAssemblyJacobian =
    DinamicaNonLineare_Controllo_4531be4f_1_computeAssemblyJacobian;
  delegate->mComputeFullAssemblyJacobian =
    DinamicaNonLineare_Controllo_4531be4f_1_computeFullAssemblyJacobian;
  delegate->mIsInKinematicSingularity =
    DinamicaNonLineare_Controllo_4531be4f_1_isInKinematicSingularity;
  delegate->mConvertStateVector =
    DinamicaNonLineare_Controllo_4531be4f_1_convertStateVector;
  ...
  void initSimulationDelegate(SmMechanismDelegate *delegate)
{
  ...
  delegate->mResetStateVector =
    DinamicaNonLineare_Controllo_4531be4f_1_resetSimStateVector;
  delegate->mInitializeTrackedAngleState = NULL;
  delegate->mComputeDiscreteState = NULL;
  delegate->mAdjustPosition = NULL;
  delegate->mPerturbJointPrimitiveState =
    DinamicaNonLineare_Controllo_4531be4f_1_perturbSimJointPrimitiveState;
  delegate->mPerturbFlexibleBodyState =
    DinamicaNonLineare_Controllo_4531be4f_1_perturbFlexibleBodyState;
  ...
  delegate->mConstructStateVector =
    DinamicaNonLineare_Controllo_4531be4f_1_constructStateVector;
  delegate->mExtractSolverStateVector =
    DinamicaNonLineare_Controllo_4531be4f_1_extractSolverStateVector;
  delegate->mIsPositionViolation =
    DinamicaNonLineare_Controllo_4531be4f_1_isPositionViolation;
  delegate->mIsVelocityViolation =
    DinamicaNonLineare_Controllo_4531be4f_1_isVelocityViolation;
  delegate->mProjectStateSim =
    DinamicaNonLineare_Controllo_4531be4f_1_projectStateSim;
  delegate->mComputeConstraintError =
    DinamicaNonLineare_Controllo_4531be4f_1_computeConstraintError;
  delegate->mResetModeVector =
    DinamicaNonLineare_Controllo_4531be4f_1_resetModeVector;
  delegate->mHasJointDisToNormModeChange =
    DinamicaNonLineare_Controllo_4531be4f_1_hasJointDisToNormModeChange;
  delegate->mPerformJointDisToNormModeChange =
    DinamicaNonLineare_Controllo_4531be4f_1_performJointDisToNormModeChange;
  delegate->mOnModeChangedCutJoints =
    DinamicaNonLineare_Controllo_4531be4f_1_onModeChangedCutJoints;
  delegate->mMech = NULL;
}
