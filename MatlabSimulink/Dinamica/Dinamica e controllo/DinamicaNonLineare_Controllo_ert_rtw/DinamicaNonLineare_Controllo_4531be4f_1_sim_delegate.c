...
void DinamicaNonLineare_Controllo_4531be4f_1_perturbSimJointPrimitiveState(const
...
void DinamicaNonLineare_Controllo_4531be4f_1_perturbFlexibleBodyState(const void
...
void DinamicaNonLineare_Controllo_4531be4f_1_constructStateVector(const void
...
void DinamicaNonLineare_Controllo_4531be4f_1_extractSolverStateVector(const void
...
boolean_T DinamicaNonLineare_Controllo_4531be4f_1_isPositionViolation(const void
...
boolean_T DinamicaNonLineare_Controllo_4531be4f_1_isVelocityViolation(const void
  *mech, const RuntimeDerivedValuesBundle *rtdv, const int *eqnEnableFlags,
  const double *state, const int *modeVector)
{
  const double *rtdvd = rtdv->mDoubles.mValues;
...
PmfMessageId DinamicaNonLineare_Controllo_4531be4f_1_projectStateSim(const void *
  mech, const RuntimeDerivedValuesBundle *rtdv, const int *eqnEnableFlags, const
  int *modeVector, double *state, void *neDiagMgr0)
{
  const double *rtdvd = rtdv->mDoubles.mValues;
  const int *rtdvi = rtdv->mInts.mValues;
...
void DinamicaNonLineare_Controllo_4531be4f_1_computeConstraintError(const void
...
PmfMessageId
  DinamicaNonLineare_Controllo_4531be4f_1_performJointDisToNormModeChange(const
...
void DinamicaNonLineare_Controllo_4531be4f_1_onModeChangedCutJoints(const void
