...
PRODUCT_NAME              = Progetto_Complessivo
MAKEFILE                  = Progetto_Complessivo.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2020b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2020b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/Tommaso/UNIVER~1/CONTRO~1/Nuovo/RELAZI~1/GitRepo/MATLAB~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Progetto_Complessivo.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=2 -DMW_PRESCALAR=128 -DMW_TIMERCOUNT=131 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=115200 -D_RTT_ANALOG_REF_=0 -D_RTT_NUMSERVOS_=4
...
%.o : $(START_DIR)/Progetto_Complessivo_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Progetto_Complessivo_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Progetto_Complessivo_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Progetto_Complessivo.o : $(START_DIR)/Progetto_Complessivo_ert_rtw/Progetto_Complessivo.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Progetto_Complessivo_data.o : $(START_DIR)/Progetto_Complessivo_ert_rtw/Progetto_Complessivo_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Progetto_Complessivo_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Progetto_Complessivo_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Progetto_Complessivo_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Progetto_Complessivo_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
